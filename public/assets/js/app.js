!function() {
    "use strict";
    var t, e, a, s, n, o = localStorage.getItem("language"), l = "en";
    ...
    function m() {
        ...
        s.hasAttribute("data-layout") && "horizontal" == s.getAttribute("data-layout") ? (b("layout-horizontal"),
        ...
        "light" == s.hasAttribute("data-topbar") ? (b("topbar-color-light"),
        document.body.setAttribute("data-topbar", "light")) : "dark" == s.hasAttribute("data-topbar") && (b("topbar-color-dark"),
    ...
    function() {
        ...
        for (var t = document.getElementsByClassName("vertical-menu-btn"), a = 0; a < t.length; a++)
            t[a] && t[a].addEventListener("click", function(t) {
                ...
                992 <= window.innerWidth ? null == e ? null == document.body.getAttribute("data-sidebar-size") || "lg" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "lg") : "md" == e ? "md" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "md") : "sm" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "lg") : document.body.setAttribute("data-sidebar-size", "sm") : d()
            })
    }(),
    setTimeout(function() {
    ...
    "light" == a.hasAttribute("data-topbar") ? (b("topbar-color-light"),
    document.body.setAttribute("data-topbar", "light")) : "dark" == a.hasAttribute("data-topbar") && (b("topbar-color-dark"),
    document.body.setAttribute("data-topbar", "dark")),
    document.getElementById("sidebar-setting").style.display = "none",
    document.body.removeAttribute("data-sidebar")) : b("layout-vertical"),
    ...
    document.querySelectorAll("input[name='layout'").forEach(function(t) {
        t.addEventListener("change", function(t) {
            ...
            document.getElementsByClassName("footer")[0].style.display = "none") : (b("layout-horizontal"),
            b("topbar-color-light"),
            document.body.setAttribute("data-topbar", "light"),
    ...
    document.querySelectorAll("input[name='layout-mode']").forEach(function(t) {
        t.addEventListener("change", function(t) {
            t && t.target && t.target.value && ("light" == t.target.value ? (document.body.setAttribute("data-bs-theme", "light"),
            document.body.setAttribute("data-topbar", "light"),
            document.body.setAttribute("data-sidebar", "light"),
            a.hasAttribute("data-layout") && "horizontal" == a.getAttribute("data-layout") || document.body.setAttribute("data-sidebar", "light"),
            b("topbar-color-light"),
            b("sidebar-color-light")) : "dark" == t.target.value ? (document.body.setAttribute("data-bs-theme", "dark"),
            document.body.setAttribute("data-topbar", "dark"),
            document.body.setAttribute("data-sidebar", "dark"),
            a.hasAttribute("data-layout") && "horizontal" == a.getAttribute("data-layout") || document.body.setAttribute("data-sidebar", "dark"),
            b("topbar-color-dark")) : "bordered" == t.target.value && document.body.setAttribute("data-bs-theme", "bordered"))
        })
    }),
    ...
    d(),
    (n = document.getElementById("checkAll")) && (n.onclick = function() {
