                ...
                <div class="row g-3">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="search" class="form-control"
                            placeholder="Search by title, author, description..." value="{{ request('search') }}">
                    </div>
                        ...
                        <tbody>
                            @forelse($blogs as $blog)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            @if($blog->thumbnail_image)
                                                <img src="{{ asset('storage/' . $blog->thumbnail_image) }}" alt="Thumbnail"
                                                    style="width: 40px; height: 40px; object-fit: cover; border-radius: 6px; margin-right: 12px;">
                                            @else
                                                <div
                                                    style="width: 40px; height: 40px; background: #e5e7eb; border-radius: 6px; margin-right: 12px; display: flex; align-items: center; justify-content: center;">
                                            ...
                                            <div>
                                                ...
                                                <small
                                                    class="d-block text-muted">{{ Str::limit($blog->short_description, 60) }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <small>{{ ($blog->published_at ?? $blog->created_at)->format('M d, Y') }}</small>
                                    </td>
                                    <td>
