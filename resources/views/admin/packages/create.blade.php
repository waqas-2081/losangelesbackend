...
@section('content')
    ...
    <div class="container-fluid py-4" style="max-width: 1000px; margin: 0 auto;">
        ...
        <!-- Main Package Form -->
        <form action="{{ route('admin.packages.store') }}" method="POST" id="packageForm" autocomplete="off">
            @csrf
            ...
            <div class="layout-grid">
                ...
                <div class="card-box">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="packageName" class="form-control" value="{{ old('name') }}"
                            required>
                    </div>
                    ...
                    <div class="form-row-2 mb-3">
                        <div>
                            ...
                            <select name="price_type" id="priceType" class="form-select required" required>
                                <option value="one_time" {{ old('price_type') == 'one_time' ? 'selected' : '' }}>One Time
                                    Payment</option>
                                <option value="project" {{ old('price_type') == 'project' ? 'selected' : '' }}>Per Project
                                </option>
                            </select>
                        </div>
                        <div>
                    ...
                    <div class="form-row-2 mb-3">
                        <div>
                            ...
                            <input type="text" name="badge" id="packageBadge" class="form-control"
                                value="{{ old('badge') }}" placeholder="e.g., MOST POPULAR, BEST SELLER">
                        </div>
                        <div>
                            ...
                            <div class="status-row">
                                ...
                                <span class="toggle-label"
                                    id="activeLabel">{{ old('is_active', 1) ? 'Active' : 'Inactive' }}</span>
                            </div>
                        </div>
                    </div>
                    <!-- Features Card -->
                ...
                <div class="card-box" style="height: fit-content;">
                    <h5>Quick Actions</h5>
                    <button type="submit" class="btn-save mb-3 w-100"><i class="fas fa-save me-2"></i> Create
                        Package</button>
            ...
            <div class="footer-bar">
                ...
                <div class="footer-actions">
                    <a href="{{ route('admin.packages.index') }}" class="btn-discard">Discard</a>
